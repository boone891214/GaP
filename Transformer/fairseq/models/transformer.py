...
class TransformerModel(nn.Module):
    ...
    def build_model(cls, args):
        ...
        if args.share_all_embeddings:
            ...
            print("ENCODER EMBED DIM = ",args.encoder_embed_dim)
...
# Larger embedding
@register_model_architecture('transformer', 'transformer_wmt_en_de_big_t2t_LargerEmbed')
def transformer_wmt_en_de_big_t2t_LargerEmbed(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 1152)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 4608)
    args.encoder_normalize_before = getattr(args, 'encoder_normalize_before', True)
    args.decoder_normalize_before = getattr(args, 'decoder_normalize_before', True)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 1152)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 4608)
    args.relu_dropout = getattr(args, 'relu_dropout', 0.1)
    transformer_vaswani_wmt_en_de_big(args)
