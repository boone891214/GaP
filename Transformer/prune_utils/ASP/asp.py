...
class ASP:
    ...
    @classmethod
    def prune_trained_model(cls, model, optimizer, pattern="m4n2_2d_best",custom_layer_dict={},disallowed_layer_names=[]):
        ...
        #cls.init_model_for_pruning(model, mask_calculator="m4n2_1d", verbosity=2, whitelist=[torch.nn.Linear, torch.nn.Conv2d], allow_recompute_mask=False, custom_layer_dict=custom_layer_dict)
        cls.init_model_for_pruning(model, mask_calculator=pattern, verbosity=2, whitelist=[torch.nn.Linear, torch.nn.Conv2d], allow_recompute_mask=False, custom_layer_dict=custom_layer_dict, disallowed_layer_names=disallowed_layer_names)
