...
SAVE_FOLDER=/results/${MODEL_ARCH}_oneshot_HVB_ep${EPOCH}_LR${LRATE}_${SAVE_FOLDER_TAIL}/
mkdir -p ${SAVE_FOLDER}
...
"--resume ${LOAD_CKPT} --restart-training --sp-backbone --sp-retrain --sp-admm-sparsity-type 4:2-H-V-balanced --sp-prune-before-retrain --sp-config-file ${SP_CONFIG_FILE}" \
